...
const Header = () => {
    ...
    return (
        <header className={`inset-x-0 z-50 w-full mx-auto sticky border-b border-transparent lg:border-white/10 backdrop-blur-md bg-opacity-50 brightness-125 ${scrollDirection === "down" ? "-top-32" : "top-0"} transition-all duration-500`}>
