...
const hackathons = {
    2025: {
        ...
        participants: [
            ...
            { teamName: "Think Green", score: 148, names: ["Վարդան Շերմազանյան", "Ղազարյան Վահրամ", "Գևորգ Մանուկյան"], link: "https://github.com/manukyangev/berqTelegramBot", description: "ԲերքBot նախագիծը ոչ միայն տեխնոլոգիական հետաքրքիր նախաձեռնություն է, այլև գործնական լուծում՝ գյուղատնտեսության արդիականացման ուղղությամբ։ Այն մատչելի է, օպերատիվ և կարող է ընդլայնվել՝ ներառելով նոր տվիչներ, վերլուծական գործիքներ և նույնիսկ ինքնավար որոշումների կայացման մեխանիզմներ։ ԲերքBot-ը աշխատում է Arduino-ի հիմքով ստեղծված լաբորատոր սարքի օգնությամբ որի շնորհիվ բոտին փոխանցում է այդ պահին հողի տվյալներ և առաջարկում օպտիմալ մշակաբույս տարածքում ցանքս կատարելու և լավագույնս բերք ստանալու համար։ Նման լուծումները կարող են իրական ազդեցություն ունենալ գյուղատնտեսների արտադրողականության վրա և նպաստել կայուն, տվյալահեն գյուղատնտեսության ձևավորմանը Հայաստանում։" },
        ],
    },
};
                                            ...
                                            <li className="text-base lg:text-xl">
                                                <AccordionButton className='flex justify-between w-full items-center'>
                                                    <div className="flex  items-start space-x-1 min-w-0">
                                                        ...
                                                        <span className={`${idx < 3 ? "text-white" : "text-primary-text"} truncate`}>
                                                ...
                                                {participant.link &&
                                                    <div className='text-end mt-2'>
                                                        <Link
                                                            ...
                                                            <Image src={"/github.png"} width={16} height={16} alt={"GitHub logo"} />
